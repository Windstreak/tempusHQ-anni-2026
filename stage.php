...
<body>
    ...
    <main>
        ...
        <audio class="bgm" autoplay loop>
            <source src="Assets/bgm_Become_a_horizontal_line.mp3" type="audio/mpeg">
        </audio>
        ...
        <div class="scrollframe">
            ...
            <img class="chibis" src="Sea of Stars stage chibis/seaofstarscheeb - set.png" loading="lazy">
            ...
            <img class="donorlist" src="Assets/donorlist.png">
            <img class="chibis" src="Sea of Stars stage chibis/seaofstarscheeb - set.png" loading="lazy">
        </div>
    </main>
